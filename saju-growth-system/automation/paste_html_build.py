...
BLOCKS = [
    ...
    },
    {
        ...
        "type": "text",
        "limit": 500,
        "body": "경오일주는 재물운이 좋은데 왜 늘 돈이 없을까요?\n\n타고난 재물 그릇이 큰데도 손에 안 남는 데는,\n'버는 자리'와 '지키는 자리'가 따로 노는 명식 구조가 있어요.\n\n당신 일주는 어떤가요? 댓글에 적어주시면 한 줄 봐드릴게요.",
    },
    {
        "section": "4. SNS 게시(Day4)",
        "title": "Threads ② 숫자형",
    ...
    },
    {
        ...
        "type": "text",
        "limit": 500,
        "body": '"나는 분명 재물운 좋다는데 왜 통장은 늘 그대로지?"\n경오일주만의 얘기가 아니에요. 같은 고민, 의외로 많아요.\n\n본인 얘기 같은 분, 댓글에 일주 적어주세요.\n제가 직접 한 줄씩 봐드릴게요.',
    },
    {
        "section": "4. SNS 게시(Day4)",
        ...
        "type": "text",
        "limit": 0,
        "body": "1장(표지): 경오일주는 재물운이 좋은데 / 왜 늘 돈이 없을까요?\n2장: 타고난 '재물 그릇'은 큰 편 — 버는 힘은 충분합니다\n3장: 문제는 '지키는 자리'. 버는 자리와 따로 놀면 손에 안 남아요\n4장: 돈 새는 패턴 3가지 ① 나가는 길이 더 넓음 ② 관리 자리 공백 ③ 사람·인정에 과지출\n5장: 같은 경오일주라도 '세부 흐름(자미두수)'에 따라 방향이 다르게 보일 수 있어요\n6장(마무리): 당신 일주는 어떤가요? 댓글에 적어주시면 한 줄 봐드릴게요",
    },
    {
        "section": "4. SNS 게시(Day4)",
    ...
    },
    {
        ...
        "type": "text",
        "limit": 0,
        "body": '프레임1: "경오일주, 돈 잘 버는데 안 모이는 편?" + 투표 스티커 [나도 그래 / 난 반대]\n프레임2: "버는 자리 ≠ 지키는 자리. 둘이 따로 놀면 손에 안 남을 수 있어요. / 같은 일주여도 월지·시지·세부 흐름에 따라 또 갈려요" (배경 단색 다크브라운/딥네이비 + 화이트 텍스트)\n프레임3: "내 일주는 어느 쪽일까?" + 질문 스티커 + 채팅 링크 스티커',
    },
    {
        "section": "4. SNS 게시(Day4)",
        ...
        "type": "text",
        "limit": 0,
        "body": "제목(검색용): 경오일주 재물운, 좋은데 왜 돈이 안 모일까? #사주 #일주 #재물운\n[0-3초] 경오일주, 재물운 좋다는데 왜 통장은 항상 제자리일까요?\n[3-8초] 이유가 있어요. 버는 자리와 지키는 자리가 따로 놀거든요.\n[8-14초] 패턴이 3가지인데. 첫째, 나가는 길이 더 넓은 구조.\n[14-19초] 둘째, 관리 자리 자체가 공백인 경우. 셋째, 사람·인정에 흐름이 빠지는 경우.\n[19-25초] 같은 경오일주라도 이 흐름은 자미두수로 봐야 더 선명하게 보여요.\n[25-30초] 다음 편에서 어떻게 다른지 보여드릴게요. 구독 눌러두세요.",
    },
    {
        "section": "4. SNS 게시(Day4)",
        ...
        "type": "text",
        "limit": 0,
        "body": '화면 텍스트 오버레이(0초): "재물운 좋은데 왜 돈이 없지?"\n캡션 첫 줄(TikTok 검색용): 재물운 있는데 돈 안 모이는 이유\n본문: 버는 자리 따로, 지키는 자리 따로 — 명식에 답이 있어요. 3가지 패턴 중 어느 쪽?\n마무리(CTA): 본인 얘기 같으면 댓글에 일주 적어주세요\n해시태그: #사주 #일주 #재물운\n사운드: 잔잔한 성찰·집중형(로파이·피아노 계열). 주제와 괴리되는 밈 사운드는 제외.',
    },
    {
        "section": "4. SNS 게시(Day4)",
    ...
    },
    {
        ...
        "type": "text",
        "limit": 0,
        "body": "소프트: 당신 일주는 어떤가요? 댓글에 적어주시면 한 줄 봐드릴게요.\n직접: 내 재물 흐름이 어느 쪽인지, 프로필 채팅으로 한 가지만 가볍게 물어보세요.\n운영안내: 이번 주 재오픈 기간 중에는 교차 리딩 접수를 같이 받아요.",
    },
    {
        "section": "4. SNS 게시(Day4)",
