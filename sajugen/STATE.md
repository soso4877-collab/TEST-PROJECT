...
>   진행 상태: **Phase 1·2·3 완료 · Phase 4 진행 중**(T4.1·T4.2 완료). ★ 다음 작업 = **Phase 4 T4.3**
>     (masking 보강 — 출생지 입력값 문자열 결정론 치환 + 시각 표현 '오전 7시'/'7시반' 패턴 확장; G-6).
>     이후 T4.4(윤달 15일분할 고지 자동삽입 — 먼저 현 경로 고지 유무 E2E 확인)·T4.5(/generate 구형경로
