...
>
>   [★★ 진입점 변경 — 운영자 지시 2026-08-22. 이 줄이 우선한다]
>     **첫 작업 = `guard-false-positive-triage-20260822`(가드 오탐 원인 확정).** manifest 에 고정됨,
>     `planned / next_actor=claude`. 근거는 운영자 판단 — **도구 마찰은 모든 후속 작업에 곱해진다.**
