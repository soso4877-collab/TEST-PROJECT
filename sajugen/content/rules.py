...
def build_all(
    ...
    T["cover"] = (
        ...
        f"이 자료는 명리학·자미두수 전통 해석 체계에 기반한 참고용 상담 자료입니다."
    )
    ...
    T["wonguk"] = (
        ...
        + (
            ...
            "추정값으로 두었습니다. 시주·시간 기반 풀이는 참고로만 보시고, "
            "정확한 생시를 아시면 다시 한번 점검하시길 권합니다."
            if unknown_time
            else ""
        )
    )
    ...
    T["health"] = (
        ...
        f"뿐입니다. 몸에 이상이 느껴지면 의료 전문가와 상의하시기를 권합니다.\n"
        ...
        f"이상이 느껴지면 전문가와 상의하세요. 이 장은 건강을 단정하지 않으며, "
        f"생활 관리의 결을 보는 참고로만 활용하시길 권합니다."
    )
